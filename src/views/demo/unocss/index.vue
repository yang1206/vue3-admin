<template>
  <CommonPage :show-footer="true">
    <p>
      文档：<a c-blue hover-decoration-underline href="https://uno.antfu.me/" target="_blank">https://uno.antfu.me/</a>
    </p>
    <p>
      playground：
    ...
    <div mt-20 w-350 f-c-c flex-col>
      <div flex flex-wrap justify-around b-1 rounded-10 p-10 bc-ccc>
        <div m-20 h-50 w-50 f-c-c b-1 rounded-5 border-solid p-10>
          <span h-6 w-6 rounded-3 bg-black dark:bg-white />
        </div>
        <div m-20 h-50 w-50 flex justify-between b-1 rounded-5 border-solid p-10>
          <span h-6 w-6 rounded-3 bg-black dark:bg-white />
        ...
        <div m-20 h-50 w-50 flex-col items-center justify-between b-1 rounded-5 border-solid p-10>
        ...
        <div m-20 h-50 w-50 flex-col justify-between b-1 rounded-5 border-solid p-10>
          <div w-full flex justify-between>
            <span h-6 w-6 rounded-3 bg-black dark:bg-white />
            <span h-6 w-6 rounded-3 bg-black dark:bg-white />
          </div>
